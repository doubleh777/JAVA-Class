...
public class Check8Direction implements ICheckDirection{
	...
	public Check8Direction(int[][] maze){
		this.maze = maze;
		stack.push(XY);
	}
	...
	public void checkDirection() {
		...
		if(XY.getX()==8 && XY.getY()==8){
			...
			System.out.println("This is the route. (Direction8)");
			System.out.println("");
		...
		if(maze[x][y] == 1){
			...
			else if(XY.getCurDir() == "Right-Down"){
				stack.push(XY);
				this.gotoRight();
				this.gotoRight_Down();
				this.gotoDown();
			...
			else if(XY.getCurDir() == "Left-Down"){
				stack.push(XY);
				this.gotoRight();
				this.gotoRight_Down();
				this.gotoDown();
	...
	public void gotoRight_Up(){
		x = x-1;
		y = y+1;
		XY.setCoordinates(x, y, "Right-Up");
		this.checkDirection();
	}
	public void gotoRight_Down(){
		x = x+1;
		y = y+1;
		XY.setCoordinates(x, y, "Right-Down");
		this.checkDirection();
	}
	public void gotoLeft_Down(){
		x = x+1;
		y = y-1;
		XY.setCoordinates(x, y, "Left-Down");
		this.checkDirection();
	}
	public void gotoLeft_Up(){
		x = x-1;
		y = y-1;
		XY.setCoordinates(x, y, "Left-Up");
		this.checkDirection();
	}
