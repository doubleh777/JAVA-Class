...
public static int parseString(String region) throws NoRegionException {
	
	if(region.equals("Seoul")) return Seoul;
	else if(region.equals("Chuncheon")) return Chuncheon;
	else if(region.equals("Wonju")) return Wonju;
	else if(region.equals("Asan")) return Asan;
	else if(region.equals("Gyeongju")) return Gyeongju;
	else if(region.equals("Deajeon")) return Deajeon;
	else if(region.equals("Gwangju")) return Gwangju;
	else throw new NoRegionException();
}
